...
export function ContributeForm({ onClose }: { onClose: () => void }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (tab === "question" && !form.question.trim()) {
      setErrorMsg(
        locale === "en" ? "Please enter a question" : "Vui lòng nhập câu hỏi",
      );
      return;
    }
    if (tab === "feature" && !form.question.trim()) {
      setErrorMsg(
        locale === "en"
          ? "Please enter a feature description"
          : "Vui lòng nhập mô tả tính năng",
      );
      return;
    }
    ...
    try {
      ...
      if (res.ok) {
        ...
        setErrorMsg(
          data.error ||
            (locale === "en" ? "Submission failed" : "Gửi thất bại"),
        );
      }
    } catch {
      setStatus("error");
  ...
  return (
    <>
      ...
      <div className="iv-contribute-modal">
        ...
        <div
          className="iv-contribute-tabs"
          role="tablist"
          aria-label={
            locale === "en" ? "Contribute options" : "Tùy chọn đóng góp"
          }
        >
          <button
            id="tab-question"
          ...
          <button
            ...
            aria-controls="panel-contribute"
        ...
        {tab === "contribute" ? (
          <div
            className="iv-contribute-github-tab"
            id="panel-contribute"
            role="tabpanel"
          ...
          <div className="iv-contribute-success" role="alert">
            <svg
              width="48"
              height="48"
              viewBox="0 0 24 24"
            ...
            <p className="iv-contribute-sub">
              {locale === "en"
                ? "Your submission will be reviewed and added."
                : "Câu hỏi sẽ được review và thêm vào bộ sưu tập."}
            </p>
            <button className="iv-contribute-btn" onClick={onClose}>
              {locale === "en" ? "Close" : "Đóng"}
            </button>
          </div>
        ) : (
          <form
            className="iv-contribute-form"
            onSubmit={handleSubmit}
            id={tab === "question" ? "panel-question" : "panel-feature"}
            role="tabpanel"
            aria-labelledby={
              tab === "question" ? "tab-question" : "tab-feature"
            }
          >
            {tab === "question" ? (
              <>
                ...
                <div className="iv-contribute-field">
                  ...
                  >
                    ...
                    <option value="Khác">
                      {locale === "en" ? "Other" : "Khác"}
                    </option>
                  </select>
                </div>

                <div className="iv-contribute-field">
                  <label htmlFor="q_question">
                    {locale === "en" ? "Question" : "Câu hỏi"}{" "}
                  ...
                  <textarea
                    ...
                    placeholder={
                      locale === "en"
                        ? "Enter a question or knowledge..."
                        : "Nhập câu hỏi hoặc kiến thức..."
                    }
                    rows={3}
                    required
                  />
                ...
                <div className="iv-contribute-field">
                  <label htmlFor="q_answer">
                    {locale === "en" ? "Suggested answer" : "Gợi ý đáp án"}{" "}
                    <span className="iv-optional">
                      {locale === "en" ? "(optional)" : "(tùy chọn)"}
                    </span>
                  </label>
                  <textarea
                    ...
                    placeholder={
                      locale === "en"
                        ? "If you have a suggested answer..."
                        : "Nếu bạn có gợi ý đáp án..."
                    }
                    rows={4}
                  />
                </div>
              ...
              <>
                ...
                <div className="iv-contribute-field">
                  ...
                  <textarea
                    ...
                    placeholder={
                      locale === "en"
                        ? "What feature would you like? Describe in detail..."
                        : "Bạn muốn website có thêm tính năng gì? Mô tả chi tiết..."
                    }
                    rows={4}
                    required
                  />
                ...
                <div className="iv-contribute-field">
                  <label htmlFor="f_answer">
                    {locale === "en" ? "Reason / Benefits" : "Lý do / Lợi ích"}{" "}
                    <span className="iv-optional">
                      {locale === "en" ? "(optional)" : "(tùy chọn)"}
                    </span>
                  </label>
                  <textarea
                    ...
                    placeholder={
                      locale === "en"
                        ? "How would this feature help learning?"
                        : "Tính năng này giúp ích gì cho việc học/ôn tập?"
                    }
                    rows={3}
                  />
                </div>
                ...
                <div className="iv-contribute-field">
                  <label htmlFor="f_links">
                    {locale === "en" ? "Reference link" : "Link tham khảo"}{" "}
                    <span className="iv-optional">
                      {locale === "en" ? "(optional)" : "(tùy chọn)"}
                    </span>
                  </label>
                  <textarea
                    ...
                    placeholder={
                      locale === "en"
                        ? "Example links, screenshots..."
                        : "Link ví dụ từ website khác, ảnh minh họa..."
                    }
                    rows={2}
                  />
                </div>
            ...
            {errorMsg && (
              <div className="iv-contribute-error" role="alert">
                {errorMsg}
              </div>
            )}
            ...
            <div className="iv-contribute-actions">
              <button
                type="button"
                className="iv-contribute-btn iv-btn-secondary"
                onClick={onClose}
              >
              ...
              <button
                type="submit"
                className="iv-contribute-btn iv-btn-primary"
